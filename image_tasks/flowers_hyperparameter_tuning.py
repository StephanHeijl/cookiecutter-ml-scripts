...
def objective(trial):
    ...
    train_loader = DataLoader(
        train_set, batch_size=settings.batch_size, shuffle=True, num_workers=4
    )
    val_loader = DataLoader(
        val_set, batch_size=settings.batch_size, shuffle=False, num_workers=4
    )
...
def main(settings=None):
    ...
    test_loader = DataLoader(
        test_set, batch_size=settings.batch_size, shuffle=False, num_workers=4
    )
